...
const Sellers = () => {
  ...
  // Function to toggle delete modal visibility and set the ID to be deleted
  function showDeleteModel(id) {
    setIdDeleteModal(id)
    setDeleteModalOpen(!deleteModalOpen)
  }

  // Function to toggle update modal visibility and populate the update form with seller data
  ...
  // fetch seller data from the API on component mount
  useEffect(() => {
  ...
  // Function to handle search input and filter seller data
  ...
  async function updateUsers() {
   ...
   // Function to handle the form submission for updating seller data
